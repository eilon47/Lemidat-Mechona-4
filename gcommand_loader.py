...
class GCommandTestLoader(GCommandLoader):
    def __init__(self, root, transform=None, target_transform=None, window_size=.02, window_stride=.01,
        ...
        super(GCommandTestLoader, self).__init__(root, transform, target_transform, window_size, window_stride, window_type, normalize, max_len)
